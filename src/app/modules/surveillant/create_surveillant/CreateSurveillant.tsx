...
import { createSurveillant, fetchPays } from "../_requests/apiRequests";
...
interface CreateSurveillantProps {
  show: boolean;
  onClose: () => void;
  onCreated: () => void;
}
...
const CreateSurveillant: React.FC<CreateSurveillantProps> = ({
  show,
  onClose,
  onCreated,
}) => {
  ...
  const formik = useFormik({
    initialValues: {
      surveillant_TypeSuveillantId: 0,
      surveillant_RaisonSociale: "",
      surveillant_Nom: "",
      surveillant_Prenom: "",
      surveillant_Telephone: "",
      surveillant_Email: "",
      surveillant_PaysId: 0,
      surveillant_Statut: true,
      surveillant_Observations: "",
      surveillant_UserId: "",
    },
    ...
    onSubmit: async (values) => {
      setLoading(true);
      try {
        await createSurveillant(values);
        Swal.fire(
          "Succès",
          "Le surveillant a été créé avec succès",
          "success"
        );
        onCreated();
        onClose();
      ...
      <div className="modal-dialog modal-lg">
        <div className="modal-content shadow">
          <div className="modal-header">
            <h5 className="modal-title">Créer un nouveau surveillant</h5>
            <button
              type="button"
              className="btn-close"
              onClick={onClose}
...
export default CreateSurveillant;