...
import { fetchCompagnieMaritime, fetchPays, fetchPorts, updateNavire } from "../../_requests/apiRequests";
// import { updateNavire, fetchPays, fetchCompagnieMaritime, fetchPorts } from "../_requests/apiRequests";
...
interface EditNavireModalProps {
  show: boolean;
  onClose: () => void;
  onUpdated: () => void;
  navire: Navire;
...
const EditNavireModal: React.FC<EditNavireModalProps> = ({
  show,
  onClose,
  onUpdated,
  navire,
  ...
  const formik = useFormik({
    initialValues: {
      ...
      navire_IMO: navire.navire_IMO,
      navire_CompagnieId: navire.navire_CompagnieId,
      navire_ImmatriculationPaysId: navire.navire_ImmatriculationPaysId,
      navire_ImmatriculationPortId: navire.navire_ImmatriculationPortId,
      navire_AnneeConstruction: navire.navire_AnneeConstruction,
      navire_LongueurMettres: navire.navire_LongueurMettres,
      navire_LargeurMetres: navire.navire_LargeurMetres,
      navire_TonnageBrut: navire.navire_TonnageBrut,
      navire_TonnageNet: navire.navire_TonnageNet,
      navire_DeadweightTonnage: navire.navire_DeadweightTonnage,
      navire_Observations: navire.navire_Observations,
      navire_ValidationStatutId: navire.navire_ValidationStatutId,
      navire_Active: navire.navire_Active,
      navire_UserId: navire.navire_UserId,
    },
    ...
    onSubmit: async (values) => {
      setLoading(true);
      try {
        await updateNavire(navire.navire_Id, values);
        Swal.fire(
          "Succès",
          "Le navire a été modifié avec succès",
          "success"
        );
        onUpdated();
        onClose();
      ...
      <div className="modal-dialog modal-lg">
        <div className="modal-content shadow">
          <div className="modal-header">
            <h5 className="modal-title">Modifier le navire</h5>
            <button
              type="button"
              className="btn-close"
              onClick={onClose}
...
export default EditNavireModal;