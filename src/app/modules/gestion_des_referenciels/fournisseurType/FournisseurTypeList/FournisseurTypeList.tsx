...
import FournisseurTypeTable from "./__partials/FounisseurTypeTable";
import CreateFournisseurType from "../createFournisseurType/CreateFournisseurType";

const FournisseurTypeList: React.FC = () => {
    ...
    <div className="container-fluid px-0">
      ...
      <div className="border-0 pt-5 d-flex justify-content-between align-items-center mb-4">
        <h3 className="d-flex flex-column align-items-start">
          <span className="fw-bold custom-title text-dark">Liste des types de fournisseur</span>
            ...
            <div className="col-md-12">
              <form onSubmit={formik.handleSubmit} className="row g-3">
                <div className="col-md-9">
                  <label className="form-label" style={{ fontSize: "2rem", marginLeft: "-20px" }}>Liste des types de fournisseur disponibles</label>
      ...
      {/* Create FournisseurType Modal */}
      <CreateFournisseurType
        show={showModal}
...
export default FournisseurTypeList;