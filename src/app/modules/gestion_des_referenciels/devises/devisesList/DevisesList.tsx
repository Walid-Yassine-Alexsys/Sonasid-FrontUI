...
import DeviseTable from "./__partials/DevisesTable";
import CreateDevise from "../createDevise/CreateDevise";

const DeviseList: React.FC = () => {
    ...
    <div className="container-fluid px-0">
      ...
      <div className="border-0 pt-5 d-flex justify-content-between align-items-center mb-4">
        <h3 className="d-flex flex-column align-items-start">
          <span className="fw-bold custom-title text-dark">Liste des devises</span>
        </h3>
        <button
            ...
            <div className="col-md-12">
              <form onSubmit={formik.handleSubmit} className="row g-3">
                <div className="col-md-6">
                  <label className="form-label" style={{ fontSize: "2rem", marginLeft: "-20px" }}>Liste des devises disponibles</label>
